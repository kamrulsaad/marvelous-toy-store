                        ...
                        <div className="mt-10 lg:-mx-4 relative relative-20 lg:mt-0 lg:col-start-1">
                            <div className="relative space-y-4">
                                <div className="flex items-end justify-center lg:justify-start space-x-4">
                                    <img className="rounded-lg shadow-lg w-32 md:w-56" width="200" src="https://i.ibb.co/hyVwMX1/cesar-hernandez-IHuse226f-E-unsplash.jpg" alt="1" />
                                    <img className="rounded-lg shadow-lg w-40 md:w-64" width="260" src="https://i.ibb.co/7zj0FJ3/igor-bumba-rkaah-In-Fl-Bg-unsplash.jpg" alt="2" />
                                </div>
                                <div className="flex items-start justify-center lg:justify-start space-x-4 ml-12">
                                    <img className="rounded-lg shadow-lg w-24 md:w-40" width="170" src="https://i.ibb.co/129R29w/lucas-hoang-h2x-G7-FQbmc-I-unsplash.jpg" alt="3" />
                                    <img className="rounded-lg shadow-lg w-32 md:w-56" width="200" src="https://th.bing.com/th/id/R.b394d304a7ef6b37277389ad937f769b?rik=E4myRf47gFtHoA&riu=http%3a%2f%2fcomicsbeat.com%2fwp-content%2fuploads%2f2014%2f04%2fmarvel-logo.png&ehk=5VgPnKnA6xwS3wlppO2le4vmc5nNszMjkOz7BoHW3EY%3d&risl=&pid=ImgRaw&r=0" alt="4" />
                                </div>
                            </div>
                        </div>
                    </div>
