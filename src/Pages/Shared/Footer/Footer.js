            ...
            <div className="px-4 pt-12 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8">
                <div className="grid gap-16 row-gap-10 mb-8 lg:grid-cols-6">
                    ...
                    <div className="grid grid-cols-2 gap-5 row-gap-8 lg:col-span-4">
                        <div>
                            <p className="font-semibold tracking-wide text-sky-400">
                                Category
                            </p>
                            <ul className="mt-2 space-y-2">
                                <li>
                                    <Link
                                        to="/"
                                        className="transition-colors duration-300 text-red-50 hover:text-sky-400"
                                    >
                                        Avengers
                                    </Link>
                                </li>
                ...
                <div className="flex flex-col justify-between pt-5 pb-10 border-t border-red-200 sm:flex-row">
                    <p className="text-sm text-gray-100">
                        © Copyright {year} Marvelous Inc. All rights reserved.
                    </p>
                    <div className="flex items-center mt-4 space-x-4 sm:mt-0">
                        <Link
                            to="/"
                            className="transition-colors duration-300 text-red-100 hover:text-sky-400"
                        >
