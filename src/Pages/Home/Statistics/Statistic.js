        ...
        <div className="px-4 py-16 mx-auto sm:max-w-xl md:max-w-full lg:max-w-screen-xl md:px-24 lg:px-8 lg:py-20">
            <div className="grid gap-8 sm:grid-cols-2 lg:grid-cols-4">
                <div className="text-center">
                    <div className="flex items-center justify-center w-10 h-10 mx-auto mb-3 rounded-full bg-red-400 sm:w-12 sm:h-12">
                        <svg
                    ...
                    <h6 className="text-4xl font-bold text-sky-400">
                        819
                    </h6>
                    <p className="mb-2 font-bold text-md">Suppliers</p>
                ...
                <div className="text-center">
                    ...
                    <h6 className="text-4xl font-bold text-sky-400">91</h6>
                ...
                <div className="text-center">
                    ...
                    <h6 className="text-4xl font-bold text-sky-400">52</h6>
